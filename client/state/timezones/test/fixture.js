...
export const TIMEZONES_ATLANTIC = map( timezones_Atlantic, ( { value } ) => ( value ) );
export const TIMEZONES_ATLANTIC_OBJECT = valueLabelToObject( timezones_Atlantic );
...
export const CONTINENTS = mapValues( TIMEZONES_BY_CONTINENT, timezones => map( timezones, ( { value } ) => ( value ) ) );
export const TIMEZONES_OBJECT = mapValues( TIMEZONES_BY_CONTINENT, tzs => map( tzs, ( { value, label } ) => ( { [ value ]: label } ) ) );
export const TIMEZONES_ARRAY = map( toPairs( TIMEZONES_BY_CONTINENT ), continent =>
	[ continent[ 0 ], map( continent[ 1 ], ( { label, value } ) => [ value, label ] ) ]
);

export const LABELS_OBJECT = valueLabelToObject( TIMEZONES );
export const RAW_OFFSETS_OBJECT = valueLabelToObject( RAW_OFFSETS );
